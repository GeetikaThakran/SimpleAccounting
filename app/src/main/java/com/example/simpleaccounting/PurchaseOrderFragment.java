...
public class PurchaseOrderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        purchaseOrder_date = getView().findViewById(R.id.purchaseOrder_date);

        //set automatic date
        Calendar calendar = Calendar.getInstance();
        String currentDate = DateFormat.getDateInstance().format(calendar.getTime());
        purchaseOrder_date.setText(currentDate);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_purchase_order, container, false);
        return view;
    }
}